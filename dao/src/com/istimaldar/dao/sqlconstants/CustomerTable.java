...
public class CustomerTable {
    ...
    public static final String READ = "SELECT * FROM library.customer WHERE id = ?;";
    public static final String UPDATE = "UPDATE library.customer SET first_name = ?, last_name = ? WHERE id = ?;";
